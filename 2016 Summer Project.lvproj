...
<Project Type="Project" LVVersion="15008000">
	...
	<Item Name="Target" Type="RT myRIO">
		...
		<Property Name="alias.value" Type="Str">roboRIO-4080-FRC.local</Property>
...
AddOutputFilter chunkFilter
		...
		<Item Name="Team Code" Type="Folder">
			<Item Name="TDMS_testing" Type="Folder">
				<Property Name="NI.SortType" Type="Int">3</Property>
				<Item Name="TDMS_set-motor-test.vi" Type="VI" URL="../TDMS_set-motor-test.vi"/>
				<Item Name="TDMS_use_state.ctl" Type="VI" URL="../TDMS_use_state.ctl"/>
				<Item Name="sequence structure read.vi" Type="VI" URL="../sequence structure read.vi"/>
				<Item Name="sequence structure record-write.vi" Type="VI" URL="../sequence structure record-write.vi"/>
				<Item Name="TDMS_Write.vi" Type="VI" URL="../TDMS_Write.vi"/>
			</Item>
			<Item Name="Utilities" Type="Folder">
				<Item Name="boolean-string converter.vi" Type="VI" URL="../boolean-string converter.vi"/>
				<Item Name="float-string converter.vi" Type="VI" URL="../float-string converter.vi"/>
				<Item Name="integer-string converter.vi" Type="VI" URL="../integer-string converter.vi"/>
				<Item Name="Joystick-avg.vi" Type="VI" URL="../Joystick-avg.vi"/>
				<Item Name="Once per press.vi" Type="VI" URL="../Once per press.vi"/>
				<Item Name="Timer(SubVI).vi" Type="VI" URL="../Timer(SubVI).vi"/>
				<Item Name="V-corrected-drive.vi" Type="VI" URL="../V-corrected-drive.vi"/>
			</Item>
		...
		<Item Name="Auto_script_selector.ctl" Type="VI" URL="../Auto_script_selector.ctl"/>
		<Item Name="Binary-record-&amp;-read.vi" Type="VI" URL="../Binary-record-&amp;-read.vi"/>
		<Item Name="Binary_write.vi" Type="VI" URL="../Binary_write.vi"/>
		<Item Name="Joystick-triggers.vi" Type="VI" URL="../Joystick-triggers.vi"/>
		<Item Name="Robot Main.vi" Type="VI" URL="../Robot Main.vi"/>
		<Item Name="Robot_info_to-from_dash.vi" Type="VI" URL="../Robot_info_to-from_dash.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
